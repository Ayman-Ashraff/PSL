...
# # Function to extract keypoints and return as an np array
...
#     save_to = r"/Users/kayan/Downloads/NewKeyPoints"
#     path = r"/Users/kayan/Downloads/NewDataSet"
...
#             action_path = os.path.join(save_to, str(action))
...
#                 for aug in augs:
#                     aug_path = os.path.join(video_path, str(aug))
#                     os.makedirs(aug_path, exist_ok=True)

#                     frames = os.listdir(os.path.join(path, action, video, aug))
#                     for frame in frames:
#                         npy_path = os.path.join(aug_path, str(frame))  # npy file name
...
#     actions = list(set(completed_list))
#     action_division(actions)


# if __name__ == '__main__':
#     actions = ["sample_action"]  # Replace with actual action names from your dataset
#     action_division(actions)  # Comment/uncomment as needed

#     # Uncomment below if you want to test multiprocessing or additional functions
#     # get_arrays()
...
# function to extract keypoints for each frame and store as an npy file
def action_division(actions):
    save_to = r"/Users/kayan/Downloads/NewKeyPoints"  # Update to your desired output directory
    path = r"/Users/kayan/Downloads/NewKeyPoints"  # Update to the path where your dataset is located
...
def check(actions):
    complete = []
    var = False
    path = r"/Users/kayan/Downloads/NewKeyPoints"
    for action in actions:
        print(action)
        var = False
        videos = os.listdir(os.path.join(path, action))
...
if __name__ == '__main__':
    # Define actions based on the folders in the dataset directory
    actions = os.listdir(r'/Users/kayan/Downloads')

    # Run the action division function with the specified actions
    action_division(actions)

    # Optionally check how many actions have been completed
    check(actions)
